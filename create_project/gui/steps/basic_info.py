...
from PyQt6.QtWidgets import QFormLayout, QLabel, QLineEdit, QTextEdit, QVBoxLayout
...
class BasicInfoStep(WizardStep):
    ...
    def __init__(self, parent: Optional[Any] = None) -> None:
        ...
        super().__init__(
            "Basic Information", "Enter basic information about your project", parent
        )
    ...
    def initializePage(self) -> None:
        ...
        if wizard and hasattr(wizard, "data"):
            ...
            if hasattr(wizard, "config_manager"):
                default_author = wizard.config_manager.get_setting(
                    "defaults.author", ""
                )
    ...
    def _update_wizard_data(self) -> None:
        ...
        if wizard and hasattr(wizard, "data"):
            ...
            logger.debug(
                f"Updated wizard data: project_name={wizard.data.project_name}"
            )
