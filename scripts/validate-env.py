...
def main() -> int:
    ...
    print(f"{Colors.BOLD}Python Project Creator - Development Environment Validation{Colors.RESET}")
    print("=" * 60)
    ...
    if failed == 0:
        ...
        print(f"\nYou can now:")
        print(f"  • Run the application: {Colors.CYAN}uv run python -m create_project{Colors.RESET}")
        ...
        print(f"Please resolve the failed checks above.")
        return 1
