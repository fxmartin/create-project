...
class TestCompleteErrorContext:
    ...
    def test_complete_error_context_creation(self):
        ...
        project_ctx = ProjectContext(
            template_name="python_library",
            target_path="/projects/[USER]/test",
            project_variables={},
            options={},
...
class TestErrorContextCollector:
    ...
    def test_collect_system_context(
        self, mock_disk, mock_machine, mock_version, mock_system
    ):
    ...
    def test_collect_error_context(self):
        ...
        try:
            ...
            raise TemplateError(
                ...
                details={"validation_errors": ["Missing: name"]},
            )
    ...
    def test_collect_template_context(self):
        ...
        context = self.collector._collect_template_context(
            self.mock_template, project_variables
        )
        ...
        assert (
            len(context.missing_variables) == 0
        )  # "name" is available, "description" is optional
    ...
    def test_sanitize_value_handles_different_types(self):
        ...
        # Dict
        result = self.collector._sanitize_value(
            {"path": "/Users/test", "email": "john@example.com"}
        )
