...
from create_project.core.exceptions import PathError, TemplateError
...
class TestPromptManager:
    ...
    def test_initialization_custom_dir(self):
        ...
        manager = PromptManager(
            template_dir=self.template_dir, custom_template_dir=self.custom_dir
        )
    ...
    def test_render_prompt_no_validation(self):
        ...
        rendered = manager.render_prompt(
            PromptType.ERROR_HELP, context, validate_required=False
        )
    ...
    def test_list_templates_with_custom(self):
        ...
        (self.custom_dir / "custom_help.j2").write_text("Custom: {{ custom_var }}")
    ...
    def test_select_template_for_error(self):
        ...
        assert (
            manager.select_template_for_error(template_error) == PromptType.ERROR_HELP
        )
    ...
    def test_custom_template_precedence(self):
        ...
        (self.custom_dir / "error_help.j2").write_text("CUSTOM: {{ error_type }}")
        ...
        rendered = manager.render_prompt(
            PromptType.ERROR_HELP, {"error_type": "Test", "error_message": "msg"}
        )
