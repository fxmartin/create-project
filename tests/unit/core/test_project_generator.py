...
class TestProjectGenerator:
    ...
    def test_validate_target_path_non_empty_directory(self, project_generator, temp_dir):
    ...
    def test_prepare_template_variables(self, project_generator, sample_template):
        ...
        result = project_generator._prepare_template_variables(sample_template, input_vars)
    ...
    def test_render_files(self, project_generator, sample_template, sample_variables, temp_dir):
        """Test file rendering."""
        target_path = temp_dir / "test_project"
        progress_callback = Mock()
