...
class TestPackageImports:
    ...
    def test_main_package_import(self):
        ...
        assert hasattr(create_project, "__description__"), (
            "Package should have __description__"
        )
    ...
    def test_core_subpackage_import(self):
        ...
        assert create_project.core is not None, (
            "Core module should be importable directly"
        )
    ...
    def test_gui_subpackage_import(self):
        ...
        assert create_project.gui is not None, (
            "GUI module should be importable directly"
        )
    ...
    def test_utils_subpackage_import(self):
        ...
        assert create_project.utils is not None, (
            "Utils module should be importable directly"
        )
    ...
    def test_templates_subpackage_import(self):
        ...
        assert create_project.templates is not None, (
        ...
        assert create_project.templates.builtin is not None, (
            "Builtin templates should be importable"
        )

        # Test user templates
        import create_project.templates.user

        assert create_project.templates.user is not None, (
            "User templates should be importable"
        )
    ...
    def test_resources_subpackage_import(self):
        ...
        assert create_project.resources is not None, (
            "Resources module should be importable"
        )
    ...
    def test_structure_validator_import(self):
        ...
        assert validate_project_structure is not None, (
            "Structure validator should be importable"
        )

        # Test it's callable
        assert callable(validate_project_structure), (
            "Structure validator should be callable"
        )
    ...
    def test_main_entry_point_import(self):
        ...
        assert create_project.__main__ is not None, (
    ...
    def test_package_in_sys_modules(self):
        ...
        assert "create_project.core" in sys.modules, (
            "Core module should be in sys.modules"
        )
        assert "create_project.gui" in sys.modules, (
            "GUI module should be in sys.modules"
        )
        assert "create_project.utils" in sys.modules, (
            "Utils module should be in sys.modules"
        )
